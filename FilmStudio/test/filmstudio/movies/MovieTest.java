...
public class MovieTest {
    ...
    public void getPositionOfPersonCorrectly2() {
        assertEquals("",movie.getPositionOfPerson(new Person("Male", "Karnold", "Donitsi", 42)));
    }

    @Test
    public void movieComparedCorrectly1() {
        assertEquals(0, movie.compareTo(new Movie("Bad Grandpa", 2011, "Action", 8.0)));
    }

    @Test
    public void movieComparedCorrectly2() {
        assertTrue(movie.compareTo(new Movie("CAD Grandpa", 2013, "Comedy", 7.0)) < 0);
    }

    @Test
    public void movieComparedCorrectly3() {
        assertTrue(movie.compareTo(new Movie("Ad Grandpa", 2013, "Comedy", 7.0)) > 0);
    }
}
